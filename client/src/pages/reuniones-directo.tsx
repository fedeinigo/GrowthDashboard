        ...
        <Card className="border shadow-sm">
          ...
          <CardContent className="pt-4 space-y-6">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3 overflow-y-auto pr-2 max-h-[400px]">
                {sortedSdrs.map((sdr, idx) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="space-y-1 pl-1.5 border-l border-muted max-h-[100px] overflow-y-auto">
                        {assignments.map((a, i) => (
            ...
            {/* Top SDRs y Top BDRs - Side by side */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-blue-50 dark:bg-blue-950/30 border border-blue-100 dark:border-blue-800 rounded-xl p-4">
                ...
                <div className="space-y-2">
                  {sdrSummary.filter(s => !excludedSdrs.has(s.sdr)).slice(0, 6).map((s, idx) => {
              ...
              <div className="bg-emerald-50 dark:bg-emerald-950/30 border border-emerald-100 dark:border-emerald-800 rounded-xl p-4">
                <h4 className="text-sm font-semibold mb-3 flex items-center gap-2 text-emerald-800 dark:text-emerald-300">
                  <div className="w-2 h-2 rounded-full bg-emerald-500"></div>
                  Top BDRs (Owners)
                </h4>
                <div className="space-y-2">
                  {bdrSummary.slice(0, 6).map((b, idx) => {
              ...
              <div className="mt-4 grid grid-cols-3 gap-4">
                <div className="bg-purple-50 dark:bg-purple-950/30 border border-purple-200 dark:border-purple-800 rounded-lg p-4 text-center">
                  ...
                  <div className="text-2xl font-bold text-purple-700 dark:text-purple-300">
                    ${Math.round(funnelBySdr.reduce((sum: number, sdr: any) => sum + sdr.proposalValue, 0)).toLocaleString()}
                  </div>
                ...
                <div className="bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-800 rounded-lg p-4 text-center">
                  ...
                  <div className="text-2xl font-bold text-amber-700 dark:text-amber-300">
                    ${Math.round(funnelBySdr.reduce((sum: number, sdr: any) => sum + sdr.sprintValue, 0)).toLocaleString()}
                  </div>
                ...
                <div className="bg-gradient-to-r from-purple-50 to-amber-50 dark:from-purple-950/30 dark:to-amber-950/30 border border-purple-200 dark:border-purple-800 rounded-lg p-4 text-center">
                  ...
                  <div className="text-2xl font-bold text-foreground">
                    ${Math.round(funnelBySdr.reduce((sum: number, sdr: any) => sum + sdr.totalValue, 0)).toLocaleString()}
                  </div>
              ...
              <div className="mt-4 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3">
                {funnelBySdr.slice(0, 6).map((sdr: any) => (
                  <div key={sdr.sdrId} className="bg-muted/50 border border-border rounded-lg p-3 text-center">
                    ...
                    <div className="text-lg font-bold text-foreground">${Math.round(sdr.totalValue).toLocaleString()}</div>
